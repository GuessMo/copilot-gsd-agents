---
agent: 'agent'
description: 'GSD: Plan phase N. Runs research, creates atomic PLAN.md files, presents them for review. Usage: attach this prompt and tell the agent which phase number.'
...
2. **Plan** — Run the **Bishop** subagent with everything it needs in one call:
   ...
   _(Researcher is skipped — Planner has search tools and handles it inline)_
